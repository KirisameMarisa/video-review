    ...
    return (
        <div className="flex items-end gap-2 border-t border-[#333] p-3">
            ...
            <button
                ...
                className="mb-[2px] flex items-center justify-center size-8 rounded text-[#ff8800] hover:text-[#ffaa44] disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
            >
